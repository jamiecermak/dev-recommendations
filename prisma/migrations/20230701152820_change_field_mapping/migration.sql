...
-- DropForeignKey
ALTER TABLE "Team" DROP CONSTRAINT "Team_ownedByUserId_fkey";
...
-- AddForeignKey
ALTER TABLE "teams" ADD CONSTRAINT "teams_owned_by_user_id_fkey" FOREIGN KEY ("owned_by_user_id") REFERENCES "users"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
